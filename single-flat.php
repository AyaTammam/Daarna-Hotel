          ...
          <div class="col-lg-4 mb-2 mb-lg-0">
            <div class="row">
              ...
              <div class="col-6 bgDark">
                <div class="p-1 d-flex align-items-center">
                  ...
                  <span class="ms-5"><?php echo strlen($FloorId) > 1 ? $FloorId : '0' . $FloorId ?></span>
              ...
              <div class="col-6 bgDark">
                <div class="p-1 d-flex align-items-center">
                  ...
                  <span class="ms-5"><?php echo strlen($FlatId) > 1 ? $FlatId : '0' . $FlatId ?></span>
                  <input type="number" name="Flat" value="<?php echo $FlatId ?>" class="form-control form-control-sm shadow-none d-none" id="Flat" min="1" placeholder="1" autocomplete="off">
                </div>
              </div>
              <div class="col-6">
                <div class="p-1 d-flex align-items-center">
                  <i class="fa-solid fa-binoculars fa-fw me-2"></i>
                  <span class="ms-5"><?php echo $Data['View'] ?></span>
              ...
              <div class="col-6">
                <div class="p-1 d-flex align-items-center">
                  ...
                  <span class="ms-5"><?php echo $Data['Area'] ?></span>
                  <input type="number" name="Area" value="<?php echo $Data['Area'] ?>" class="form-control form-control-sm shadow-none d-none" id="FlatArea" min="1" placeholder="m&sup2" autocomplete="off">
                </div>
              </div>
              <div class="col-6 bgDark">
                <div class="p-1">
            ...
            <div id="flatimages">
              <div class="containerMainImageAndDelete position-relative">
                <img class="img-fluid" src="photos/<?php echo $Data['MainImage'] ?>" />
              ...
              <?php
                ...
                foreach ($images as $image) 
                {
                  ...
                  <div class="containerImageAndDelete p-1 position-relative">
                    <img class="img-fluid active" src="photos/<?php echo $image ?>" />
                    <?php
                      if (COUNT($images) > 1) 
                      {
                        ?>
                        <div class="RemoveImgFromFlat position-absolute bottom-0 end-0 text-center">
                          <button type="button" class="btn text-danger shadow-none" id="removeFlatImage" data-bs-toggle="modal" data-bs-target="#confirmimageDelete" aria-label="<?php echo $lang['Delete']; ?>" data-balloon-nofocus data-balloon-pos="up"><i class="fa-solid fa-trash fa-fw"></i></button>
                        </div>
                        <?php
                      }
                    ?>
            ...
            <div class="col-md-6">
              <div class="row mt-5">
                ...
                <div class="col-12 mt-5 d-flex justify-content-center">
                  <button type="submit" class="btn btn-outline-success hvr-grow" <?php echo COUNT($_SESSION) > 0 && !isset($_SESSION['Client']) ? 'disabled' : '' ?>><i class="fas fa-check-double align-middle"></i> <?php echo $lang['BookingNow']; ?></button>
                </div>
              </div>
            </div>
          </div>
